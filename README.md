...
If you like to build your own Luma Matrix experience using off-the-shelf components, follow the guide in the [Build your own Luma Matrix](https://ines-hpmm.github.io/pxt-luma-matrix/guides/build-your-own.html) section.
